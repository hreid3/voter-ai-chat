...
export const fetchTableDdlTool = tool({
    description: "Finds table DDLs based on the user input.",
    parameters: z.object({
        userInput: z.string().describe('The complete User Input'),
        topK: z.number().optional().default(2).describe('The number of top matches to return')
    }),
